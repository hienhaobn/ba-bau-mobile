...
const PregnancyProductsDetailScreen1 = () => {
    ...
    const renderContent = () => (
        <View>
            <Image source={Images.Product3} style={styles.headerImg} resizeMode="contain" />
            <View style={styles.itemContentContainer}>
                <Text style={styles.contentHeader}>7 thuốc sắt cho mẹ bầu dễ hấp thu, không bị nóng</Text>
...
export default PregnancyProductsDetailScreen1;
