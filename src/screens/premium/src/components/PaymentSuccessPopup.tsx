...
interface IPaymentSuccessPopupProps {
    onConfirm?: () => void;
}

export interface IPaymentSuccessPopupRef {
    showModal?: () => void;
    hideModal?: () => void;
}

const PaymentSuccessPopup = (props: IPaymentSuccessPopupProps, ref: React.Ref<IPaymentSuccessPopupRef>) => {
...
export default forwardRef(PaymentSuccessPopup);
